...
if echo "$answer" | grep -iq "^y" ;then
  ...
  echo "alias deploy2='(cd /home/libe/aquest/comp_main/lambda_graphql && sls function deploy)'" >> /home/libe/.bashrc
  echo "alias deploy2e='(cd /home/libe/aquest/comp_main/lambda_graphql && sls endpoint deploy)'" >> /home/libe/.bashrc
  echo "alias deploytest='(cd /home/libe/aquest/comp_main/lambda_test && sls function deploy)'" >> /home/libe/.bashrc
  echo "alias deployteste='(cd /home/libe/aquest/comp_main/lambda_test && sls endpoint deploy)'" >> /home/libe/.bashrc
